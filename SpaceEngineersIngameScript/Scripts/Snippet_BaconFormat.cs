...
namespace Snippet_BaconFormat
{
    public class Program : MyGridProgram
    {
        ...
        */
        ...
        {
            private BaconTextWidth fontWidthCalc = new BaconTextWidth();
